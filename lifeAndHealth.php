...
if($text == ""){
    ...
    if($num <= 18 || $num >= 80){ //adult so >18
    	...
    	$response .= "4.2,00,00,000 \n";
    }
}
else if ($exp[0] == "2" && $exp[10] == "1" && (!$exp[11])) {
	$response = "CON Top 5 quotes for You \n";
    $store["SumInsured"] = "2500000" ;
}
else if ($exp[0] == "2" && $exp[10] == "2" && (!$exp[11])) {
	$response = "CON Top 5 quotes for You \n";
    $store["SumInsured"] = "5000000" ;
}
else if ($exp[0] == "2" && $exp[10] == "3" && (!$exp[11])) {
	$response = "CON Top 5 quotes for You \n";
    $store["SumInsured"] = "10000000" ;
}
else if ($exp[0] == "2" && $exp[10] == "4" && (!$exp[11])) {
	$response = "CON Top 5 quotes for You \n";
    $store["SumInsured"] = "20000000" ;
}
else if ($exp[0]=="2" && ($exp[11])&& (!$exp[12])){
